  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <DisclosureButton className="fixed z-40 flex items-center justify-center transition duration-300 bg-blue-600 rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-blue-600 focus:bg-blue-600 ease">
              <span className="sr-only">
                Ouvrir le widget de formulaire de contact
              </span>
              <Transition
                show={!open}
              ...
              <DisclosurePanel className="flex flex-col  overflow-hidden left-0 h-full w-full sm:w-[350px] min-h-[250px] sm:h-[600px] border border-gray-300 dark:border-gray-800 bg-white shadow-2xl rounded-md sm:max-h-[calc(100vh-120px)]">
                <div className="flex flex-col items-center justify-center h-32 p-5 bg-blue-600">
                  ...
                  <p className="text-white opacity-50">
                    Nous répondons généralement dans quelques heures
                  </p>
                </div>
                <div className="flex-grow h-full p-6 overflow-auto bg-gray-50">
                  {!isSubmitSuccessful && (
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      <input
                        type="hidden"
                        value="VOTRE_CLÉ_D'ACCÈS_ICI"
                        {...register('apikey')}
                      />
                      <input
                        type="hidden"
                        value={`${userName} a envoyé un message depuis Nextly`}
                        {...register('subject')}
                      />
                      <input
                        type="hidden"
                      ...
                      <div className="mb-3">
                        <button
                          type="submit"
                          className="w-full px-3 py-4 text-white bg-blue-600 rounded-md focus:bg-blue-600 focus:outline-none"
                        >
                          {isSubmitting ? (
                            <svg
